...
export default defineConfig(({ mode }) => {
    ...
    const hmrHost = env.VITE_HMR_HOST || (devServerHost === '0.0.0.0' ? '127.0.0.1' : devServerHost);
    ...
    return {
        ...
        server: {
            ...
            hmr: {
                ...
                clientPort: Number(env.VITE_HMR_CLIENT_PORT || env.VITE_HMR_PORT || devServerPort),
