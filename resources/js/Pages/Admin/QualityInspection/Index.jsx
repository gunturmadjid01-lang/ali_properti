...
export default function Index({
    ...
    const form = useForm({
        ...
        hasil: editingRow?.hasil ?? "sesuai",
        item_pemeriksaan: editingRow?.item_pemeriksaan ?? "",
        temuan: editingRow?.temuan ?? "",
        tindakan_perbaikan: editingRow?.tindakan_perbaikan ?? "",
        target_selesai: editingRow?.target_selesai ?? "",
        status: editingRow?.status ?? "terbuka",
        foto: null,
    });
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Dropdown
                                        ...
                                        value={
                                            form.data.progress_pembangunan_id
                                        }
                    ...
                    <section className="overflow-hidden rounded-lg border border-white/80 bg-white/78 shadow-soft dark:border-white/10 dark:bg-white/8">
                        {permissions.canCreate && (
                            <div className="flex justify-end border-b border-silver-deep/50 p-5">
                                ...
                                >
                                    <Plus size={16} /> Tambah Kontrol Kualitas
                                </Button>
                            </div>
                        )}
                        <form
