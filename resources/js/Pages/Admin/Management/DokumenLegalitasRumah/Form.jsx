...
export default function DokumenLegalitasRumahForm({ open, title, fields, options, form, selected, onSubmit, onClose }) {
    return (
        <ModalForm
            open={open}
            onClose={onClose}
            title={selected ? `Edit ${title}` : `Tambah ${title}`}
            description="Kelola dokumen legalitas untuk rumah atau unit pada perumahan."
            onSubmit={onSubmit}
