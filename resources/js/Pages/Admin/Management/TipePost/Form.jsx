...
export default function TipePostForm({ open, title, fields, options, form, selected, onSubmit, onClose }) {
    return (
        <ModalForm
            open={open}
            onClose={onClose}
            title={selected ? `Edit ${title}` : `Tambah ${title}`}
            description="Atur tipe post untuk kategori pemasukan dan pengeluaran."
            onSubmit={onSubmit}
