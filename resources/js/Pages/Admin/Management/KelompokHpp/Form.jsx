...
export default function KelompokHppForm({ open, title, fields, options, form, selected, onSubmit, onClose }) {
    return (
        <ModalForm
            open={open}
            onClose={onClose}
            title={selected ? `Edit ${title}` : `Tambah ${title}`}
            description="Atur master kelompok HPP yang akan muncul di HPP perumahan dan detail rumah."
            onSubmit={onSubmit}
