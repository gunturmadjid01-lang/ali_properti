...
export default function DokumenLegalitasForm({ open, title, fields, options, form, selected, onSubmit, onClose }) {
    return (
        <ModalForm
            open={open}
            onClose={onClose}
            title={selected ? `Edit ${title}` : `Tambah ${title}`}
            description="Catat dokumen legalitas perumahan beserta nomor, masa berlaku, status, dan file."
            onSubmit={onSubmit}
