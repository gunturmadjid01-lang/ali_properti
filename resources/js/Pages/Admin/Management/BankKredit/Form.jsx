...
export default function BankKreditForm({ open, title, fields, options, form, selected, onSubmit, onClose }) {
    return (
        <ModalForm
            open={open}
            onClose={onClose}
            title={selected ? `Edit ${title}` : `Tambah ${title}`}
            description="Kelola bank kerja sama untuk pengajuan kredit atau KPR."
            onSubmit={onSubmit}
