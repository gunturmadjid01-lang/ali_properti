...
export default function PerumahanForm({ open, title, fields, options, form, selected, onSubmit, onClose }) {
    return (
        <ModalForm
            open={open}
            onClose={onClose}
            title={selected ? `Edit ${title}` : `Tambah ${title}`}
            description="Isi data proyek perumahan, cabang pengelola, area, unit, dan status."
            onSubmit={onSubmit}
