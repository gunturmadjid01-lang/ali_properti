...
export default function MasterBankForm({ open, title, fields, options, form, selected, onSubmit, onClose }) {
    return (
        <ModalForm
            open={open}
            onClose={onClose}
            title={selected ? `Edit ${title}` : `Tambah ${title}`}
            description="Kelola informasi bank dan rekening yang digunakan perusahaan."
            onSubmit={onSubmit}
