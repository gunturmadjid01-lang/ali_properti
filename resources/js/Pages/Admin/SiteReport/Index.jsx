...
export default function Index({
    ...
    const scheduleOptions = useMemo(
        () =>
            (options.siteSchedules ?? []).filter(
                (row) =>
                    !form.data.detail_rumah_id ||
                    row.detail_rumah_id === String(form.data.detail_rumah_id),
            ),
        [form.data.detail_rumah_id, options.siteSchedules],
    );
    const progressOptions = useMemo(
        ...
        [form.data.detail_rumah_id, options.progressPembangunans],
    );
    ...
    useEffect(() => {
        ...
        const valid = tahapanPembangunans.some(
            (option) =>
                option.value === String(form.data.tahapan_pembangunan_id),
        );
    ...
    return (
        <>
            ...
            <div className="grid gap-6">
                {(canCreate || (editing && canUpdate)) && (
                    <Form
                        ...
                        title={
                            editing
                                ? `Edit ${editing.kode_laporan}`
                                : "Input Laporan Harian / Mingguan"
                        }
                        description="Berfungsi sekaligus sebagai site diary, laporan pekerjaan, kendala, koordinasi, dan rencana kerja berikutnya."
                        onSubmit={submit}
                        actions={
                            <>
                                {editing && canUpdate && (
                    ...
                    >
                        ...
                        <div className="grid gap-4 md:grid-cols-4">
                            <div className="grid gap-2">
                                ...
                                <Dropdown
                                    ...
                                    onChange={(value) =>
                                        form.setData("jenis_laporan", value)
                                    }
                                />
                            </div>
                            <Input
                            ...
                            />
                            {form.data.jenis_laporan === "mingguan" && (
                                <Input
                                    label="Periode Mulai"
                                    type="date"
                                    value={form.data.periode_mulai}
                                    onChange={(event) =>
                                        form.setData(
                                            "periode_mulai",
                                            event.target.value,
                            ...
                            {form.data.jenis_laporan === "mingguan" && (
                                <Input
                                    ...
                                    type="date"
                                    value={form.data.periode_selesai}
                                    onChange={(event) =>
                                        form.setData(
                                            "periode_selesai",
                                            event.target.value,
                        ...
                        <div className="grid gap-4 md:grid-cols-3">
                            <Input
                                label="Cuaca"
                                value={form.data.cuaca}
                                onChange={(event) =>
                                    form.setData("cuaca", event.target.value)
                                }
                            />
                            <Input
                                ...
                                type="number"
                                min="0"
                                value={form.data.jumlah_pekerja}
                                onChange={(event) =>
                                    form.setData(
                                        "jumlah_pekerja",
                                        event.target.value,
                            ...
                            />
                            <Input
                                label="Tukang / Kontraktor"
                                value={form.data.kontraktor}
                                onChange={(event) =>
                                    form.setData(
                                        "kontraktor",
                                        event.target.value,
                        ...
                        <Textarea
                            ...
                            value={form.data.pekerjaan_selesai}
                            onChange={(event) =>
                                form.setData(
                                    "pekerjaan_selesai",
                                    event.target.value,
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            <Textarea
                                ...
                                value={form.data.pekerjaan_tertahan}
                                onChange={(event) =>
                                    form.setData(
                                        "pekerjaan_tertahan",
                                        event.target.value,
                            ...
                            <Textarea
                                ...
                                onChange={(event) =>
                                    form.setData("kendala", event.target.value)
                                }
                            />
                        </div>
                        <div className="grid gap-4 md:grid-cols-2">
                            <Textarea
                                label="Koordinasi / Keputusan"
                                value={form.data.koordinasi}
                                onChange={(event) =>
                                    form.setData(
                                        "koordinasi",
                                        event.target.value,
                            ...
                            <Textarea
                                ...
                                value={form.data.rencana_berikutnya}
                                onChange={(event) =>
                                    form.setData(
                                        "rencana_berikutnya",
                                        event.target.value,
            ...
            <Modal
                ...
                title={
                    detail ? `Detail ${detail.kode_laporan}` : "Detail Laporan"
                }
                footer={
                    <Button
                        type="button"
            ...
            >
                {detail && (
                    <div className="grid gap-3 text-sm">
                        ...
                        <p>
                            <b>Pekerjaan selesai:</b> {detail.pekerjaan_selesai}
                        </p>
                        <p>
                            <b>Pekerjaan tertahan:</b>{" "}
                            {detail.pekerjaan_tertahan || "-"}
                        </p>
                        <p>
                            <b>Kendala:</b> {detail.kendala || "-"}
                        </p>
                        <p>
                            <b>Koordinasi:</b> {detail.koordinasi || "-"}
                        </p>
                        <p>
                            <b>Rencana berikutnya:</b>{" "}
                            {detail.rencana_berikutnya || "-"}
                        </p>
                    </div>
                )}
            </Modal>
...
Index.layout = (page) => (
    <AdminLayout title={page?.props?.title ?? "Laporan Lapangan"}>
        {page}
    </AdminLayout>
);
