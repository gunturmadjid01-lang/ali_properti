                            ...
                            <tbody className="divide-y divide-silver-deep/50 dark:divide-white/10">
                                {rows.data.map((row) => (
                                    ...
                                    >
                                        ...
                                        <td className="max-w-md whitespace-normal px-5 py-4">
                                            {row.alamat}
                                        </td>
...
Index.layout = (page) => (
    <AdminLayout title={page?.props?.title ?? "Daftar Tukang"}>
        {page}
    </AdminLayout>
);
