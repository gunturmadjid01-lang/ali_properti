        ...
        <>
            ...
            <div className="print-shell grid gap-5">
                <div className="print-hidden flex flex-wrap items-center justify-between gap-3">
                    <Button
                        as={Link}
                        href="/admin/marketing/operasional/piutang"
                        variant="outline"
                    >
                ...
                <article className="receipt-sheet theme-light-surface mx-auto w-full max-w-4xl border border-silver-deep bg-white p-8 text-ink shadow-soft md:p-12">
                    <header className="flex flex-col gap-5 border-b-[3px] border-ink pb-6 sm:flex-row sm:items-start sm:justify-between">
                        <div>
                            ...
                            <h1 className="mt-2 font-display text-3xl font-extrabold tracking-[0.12em]">
                                KWITANSI
                            </h1>
                        </div>
                    ...
                    <dl className="mt-8 grid gap-x-8 gap-y-5 sm:grid-cols-[190px_1fr]">
                        <dt className="font-extrabold text-ink-soft">
                            Telah diterima dari
                        </dt>
...
Show.layout = (page) => (
    <AdminLayout title={page?.props?.title ?? "Kwitansi"}>{page}</AdminLayout>
);
