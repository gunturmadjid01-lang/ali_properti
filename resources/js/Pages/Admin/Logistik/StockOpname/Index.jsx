...
export default function Index({
    ...
    const submitFilter = (event) => {
        ...
        router.get(
            baseUrl,
            { search, gudang_id: gudangId, sort, direction },
        ...
        <>
            ...
            <section className="overflow-hidden rounded-2xl border border-white/70 bg-white/85 shadow-soft dark:border-white/10 dark:bg-white/6">
                <div className="border-b border-silver-deep/50 bg-silver-soft/55 px-4 py-3 dark:border-white/10 dark:bg-white/4">
                    <form
                        className="grid gap-2 xl:grid-cols-[1fr_240px_240px_220px_auto]"
                    ...
                    <div className="mt-3 text-right text-xs font-black text-ink dark:text-white">
                        ...
                        {rows.total ?? filteredRows.length}
                    </div>
                </div>
                            ...
                            {filteredRows.map((row) => (
                                ...
                                >
                                    ...
                                    <td className="px-3 py-2 text-right font-black">
                                        {decimal(row.total_selisih)}
                                    </td>
                                    <td className="px-3 py-2 font-bold text-emerald-600 dark:text-emerald-300">
                                        {row.status_label}
                                    </td>
                                    <td className="px-3 py-2">
                                        <TableActions>
                ...
                {detail && (
                    <div className="grid gap-4">
                        ...
                        <div className="grid gap-2 md:ml-auto md:w-96">
                            <TotalRow
                                label="Total Item"
                                value={detail.total_item}
                            />
                            <TotalRow
                                label="Total Selisih"
                                value={detail.total_selisih}
                                strong
                            />
                        </div>
                    </div>
