...
export default function Index({ title, baseUrl, rows = { data: [] }, filters = {}, options = {} }) {
        ...
        <>
            ...
            <div className="grid gap-6">
                <Form
                    ...
                    actions={(
                        <>
                            {editing && <Button type="button" variant="outline" onClick={resetForm}><X size={16} /> Batal</Button>}
