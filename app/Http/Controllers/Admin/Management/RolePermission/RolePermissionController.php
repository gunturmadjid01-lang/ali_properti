        ...
        return [
            ...
            [
                ...
                'modules' => [
                    ...
                    $module('bank-document-requirement', 'Paket Persyaratan Kredit', ['view', 'create', 'update', 'delete']),
            ...
            [
                ...
                'modules' => [
                    $module('gudang', 'Daftar Gudang', ['view', 'create', 'update', 'delete', 'lock', 'unlock']),
                    $module('master-material', 'Master Material', ['view', 'create', 'update', 'delete', 'unlock']),
                    $module('material-type', 'Jenis Material', ['view', 'create', 'update', 'delete']),
                    $module('material-brand', 'Merk Material', ['view', 'create', 'update', 'delete']),
                    $module('material-unit', 'Satuan Material', ['view', 'create', 'update', 'delete']),
                    ...
                    $module('supplier', 'Supplier', ['view', 'create', 'update', 'delete', 'unlock']),
                    $module('site-material-stock', 'Stok Material', ['view']),
                    $module('material-stock-opname', 'Stock Opname Material', ['view', 'create', 'update', 'delete', 'lock', 'unlock', 'view-all']),
                    $module('material-request', 'Permintaan Material'),
                    $module('material-purchase', 'Pembelian Material'),
                    $module('material-receipt', 'Pemeriksaan Barang Masuk', ['view', 'create', 'update', 'delete', 'lock', 'unlock']),
            ...
            [
                ...
                'modules' => [
                    $module('quality-upgrade', 'Kontrak Penambahan Mutu', ['view', 'create', 'update', 'delete', 'lock', 'unlock', 'print']),
                    $module('quality-upgrade-addendum', 'Addendum Penambahan Mutu', ['view', 'create', 'update', 'delete', 'lock', 'unlock', 'print']),
                    $module('quality-upgrade-handover', 'Serah Terima Penambahan Mutu', ['view', 'create', 'update', 'delete', 'lock', 'unlock', 'print']),
                    $module('quality-upgrade-defect', 'Defect Penambahan Mutu', ['view', 'create', 'update', 'delete']),
